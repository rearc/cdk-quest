...
//This is the example code from: https://github.com/aws-samples/aws-glue-samples/blob/master/GlueCustomConnectors/development/Spark/MinimalSparkConnector.java
//The demo repo aws-samples does not provide clear guidance on packaging/configuration/etc. for custom connectors built using Spark
//Including it here in an attempt to give a concrete example.
